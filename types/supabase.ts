  ...
  public: {
    Tables: {
      ...
      class_progress: {
        ...
        Relationships: [
          {
            foreignKeyName: "class_progress_classroom_id_fkey"
          ...
          {
            foreignKeyName: "class_progress_module_id_fkey"
            columns: ["module_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "class_progress_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      teacher_modules: {
        ...
        Relationships: [
          {
            foreignKeyName: "teacher_modules_teacher_id_fkey"
            columns: ["teacher_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
